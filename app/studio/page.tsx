    ...
    <>
      <StructuredData
        data={buildWebPageSchema({
          ...
          description: pageDescription,
          path: '/studio',
          breadcrumbs: [{ name: 'Studio', path: '/studio' }],
        })}
      />
        ...
        <div className='mx-auto grid max-w-6xl gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(18rem,24rem)] lg:items-start'>
          ...
          <div className='rounded-[2rem] border border-[var(--line)] bg-[color:var(--panel)/0.82] p-6 shadow-[var(--shadow-md)]'>
            ...
            <p className='mt-4 text-sm leading-7 text-[var(--ink-muted)]'>
              You work directly with one partner who understands the strategy, copy, design, and build. That keeps communication cleaner, decisions faster, and the final result more cohesive.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className='border-y border-[var(--line)] bg-[color:var(--panel)/0.55] px-4 py-20 sm:px-6 lg:px-8'>
        <div className='mx-auto grid max-w-6xl gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start'>
          <SectionIntro
            ...
            copy='The goal is not to be the right studio for everyone. It is to be the right fit for businesses that value clarity, trust, care, and a guided process.'
          />
